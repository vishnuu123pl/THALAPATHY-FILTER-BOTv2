...
TUTORIAL = environ.get('TUTORIAL', '-1001966071190')
...
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), False)
...
FQDN = str(getenv('FQDN', 'https://serial27266262-ce42f5b1acfc.herokuapp.com/')) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'.herokuapp.com'
